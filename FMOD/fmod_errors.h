...
//bruh
static const wchar_t* FMOD_WErrorString(FMOD_RESULT errcode)
{
    switch (errcode)
    {
    ...
    case FMOD_ERR_DSP_CONNECTION:            return L"DSP connection error.  Connection possibly caused a cyclic dependency or connected dsps with incompatible buffer counts.";
    case FMOD_ERR_DSP_DONTPROCESS:           return L"DSP return code from a DSP process query callback.  Tells mixer not to call the process callback and therefore not consume CPU.  Use this to optimize the DSP graph.";
    case FMOD_ERR_DSP_FORMAT:                return L"DSP Format error.  A DSP unit may have attempted to connect to this network with the wrong format, or a matrix may have been set with the wrong size if the target unit has a specified channel map.";
    case FMOD_ERR_DSP_INUSE:                 return L"DSP is already in the mixer's DSP network. It must be removed before being reinserted or released.";
    case FMOD_ERR_DSP_NOTFOUND:              return L"DSP connection error.  Couldn't find the DSP unit specified.";
    case FMOD_ERR_DSP_RESERVED:              return L"DSP operation error.  Cannot perform operation on this DSP as it is reserved by the system.";
    case FMOD_ERR_DSP_SILENCE:               return L"DSP return code from a DSP process query callback.  Tells mixer silence would be produced from read, so go idle and not consume CPU.  Use this to optimize the DSP graph.";
    case FMOD_ERR_DSP_TYPE:                  return L"DSP operation cannot be performed on a DSP of this type.";
    ...
    case FMOD_ERR_FILE_DISKEJECTED:          return L"Media was ejected while reading.";
    case FMOD_ERR_FILE_EOF:                  return L"End of file unexpectedly reached while trying to read essential data (truncated?).";
    case FMOD_ERR_FILE_ENDOFDATA:            return L"End of current chunk reached while trying to read data.";
    case FMOD_ERR_FILE_NOTFOUND:             return L"File not found.";
    case FMOD_ERR_FORMAT:                    return L"Unsupported file or audio format.";
    case FMOD_ERR_HEADER_MISMATCH:           return L"There is a version mismatch between the FMOD header and either the FMOD Studio library or the FMOD Low Level library.";
    ...
    case FMOD_ERR_INTERNAL:                  return L"An error occured in the FMOD system. Use the logging version of FMOD for more information.";
    case FMOD_ERR_INVALID_FLOAT:             return L"Value passed in was a NaN, Inf or denormalized float.";
    ...
    case FMOD_ERR_INVALID_POSITION:          return L"An invalid seek position was passed to this function.";
    case FMOD_ERR_INVALID_SPEAKER:           return L"An invalid speaker was passed to this function based on the current speaker mode.";
    case FMOD_ERR_INVALID_SYNCPOINT:         return L"The syncpoint did not come from this sound handle.";
    case FMOD_ERR_INVALID_THREAD:            return L"Tried to call a function on a thread that is not supported.";
    case FMOD_ERR_INVALID_VECTOR:            return L"The vectors passed in are not unit length, or perpendicular.";
    case FMOD_ERR_MAXAUDIBLE:                return L"Reached maximum audible playback count for this sound's soundgroup.";
    case FMOD_ERR_MEMORY:                    return L"Not enough memory or resources.";
    case FMOD_ERR_MEMORY_CANTPOINT:          return L"Can't use FMOD_OPENMEMORY_POINT on non PCM source data, or non mp3/xma/adpcm data if FMOD_CREATECOMPRESSEDSAMPLE was used.";
    case FMOD_ERR_NEEDS3D:                   return L"Tried to call a command on a 2d sound when the command was meant for 3d sound.";
    case FMOD_ERR_NEEDSHARDWARE:             return L"Tried to use a feature that requires hardware support.";
    ...
    case FMOD_ERR_NET_WOULD_BLOCK:           return L"Operation on a non-blocking socket could not complete immediately.";
    case FMOD_ERR_NOTREADY:                  return L"Operation could not be performed because specified sound/DSP connection is not ready.";
    ...
    case FMOD_ERR_OUTPUT_FORMAT:             return L"Soundcard does not support the specified format.";
    case FMOD_ERR_OUTPUT_INIT:               return L"Error initializing output device.";
    case FMOD_ERR_OUTPUT_NODRIVERS:          return L"The output device has no drivers installed.  If pre-init, FMOD_OUTPUT_NOSOUND is selected as the output mode.  If post-init, the function just fails.";
    case FMOD_ERR_PLUGIN:                    return L"An unspecified error has been returned from a plugin.";
    case FMOD_ERR_PLUGIN_MISSING:            return L"A requested output, dsp unit type or codec was not available.";
    case FMOD_ERR_PLUGIN_RESOURCE:           return L"A resource that the plugin requires cannot be allocated or found. (ie the DLS file for MIDI playback)";
    case FMOD_ERR_PLUGIN_VERSION:            return L"A plugin was built with an unsupported SDK version.";
    case FMOD_ERR_RECORD:                    return L"An error occurred trying to initialize the recording device.";
    case FMOD_ERR_REVERB_CHANNELGROUP:       return L"Reverb properties cannot be set on this channel because a parent channelgroup owns the reverb connection.";
    case FMOD_ERR_REVERB_INSTANCE:           return L"Specified instance in FMOD_REVERB_PROPERTIES couldn't be set. Most likely because it is an invalid instance number or the reverb doesn't exist.";
    case FMOD_ERR_SUBSOUNDS:                 return L"The error occurred because the sound referenced contains subsounds when it shouldn't have, or it doesn't contain subsounds when it should have.  The operation may also not be able to be performed on a parent sound.";
    ...
    case FMOD_ERR_SUBSOUND_CANTMOVE:         return L"Shared subsounds cannot be replaced or moved from their parent stream, such as when the parent stream is an FSB file.";
    case FMOD_ERR_TAGNOTFOUND:               return L"The specified tag could not be found or there are no tags.";
    case FMOD_ERR_TOOMANYCHANNELS:           return L"The sound created exceeds the allowable input channel count.  This can be increased using the 'maxinputchannels' parameter in System::setSoftwareFormat.";
    case FMOD_ERR_TRUNCATED:                 return L"The retrieved string is too long to fit in the supplied buffer and has been truncated.";
    ...
    case FMOD_ERR_EVENT_ALREADY_LOADED:      return L"The specified bank has already been loaded.";
    case FMOD_ERR_EVENT_LIVEUPDATE_BUSY:     return L"The live update connection failed due to the game already being connected.";
    case FMOD_ERR_EVENT_LIVEUPDATE_MISMATCH: return L"The live update connection failed due to the game data being out of sync with the tool.";
    case FMOD_ERR_EVENT_LIVEUPDATE_TIMEOUT:  return L"The live update connection timed out.";
    case FMOD_ERR_EVENT_NOTFOUND:            return L"The requested event, parameter, bus or vca could not be found.";
    case FMOD_ERR_STUDIO_UNINITIALIZED:      return L"The Studio::System object is not yet initialized.";
    case FMOD_ERR_STUDIO_NOT_LOADED:         return L"The specified resource is not loaded, so it can't be unloaded.";
    case FMOD_ERR_INVALID_STRING:            return L"An invalid string was passed to this function.";
    case FMOD_ERR_ALREADY_LOCKED:            return L"The specified resource is already locked.";
    case FMOD_ERR_NOT_LOCKED:                return L"The specified resource is not locked, so it can't be unlocked.";
    case FMOD_ERR_RECORD_DISCONNECTED:       return L"The specified recording driver has been disconnected.";
    case FMOD_ERR_TOOMANYSAMPLES:            return L"The length provided exceeds the allowable limit.";
